...
func (c *Conn) applyTransportParameters() {
	if c.perspective == protocol.PerspectiveClient && c.peerParams.ReceiveTimestampsEnabled == 1 {
		c.receivedPacketHandler.EnableReceiveTimestamps(c.peerParams.MaxReceiveTimestamps, c.peerParams.ReceiveTimestampsExponent)
	}
	params := c.peerParams
